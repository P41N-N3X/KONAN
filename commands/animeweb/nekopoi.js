...
module.exports = {
    ...
    start: async(zenon, m, { text }) => {
        if (text.toLowerCase() === "random") {
            ...
            //zenon.sendFile(m.from, fetch.result.img, "", m, { caption }) the picture hit the internet is positive
            ...
            //zenon.sendFile(m.from, fetch.result[0].img, "", m, { caption }) the picture hit the internet is positive
            zenon.sendText(m.from, caption, m)
        } else {
